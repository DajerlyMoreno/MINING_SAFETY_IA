...
REM Puertos: 8000-8006 (todos los servicios) + 3000 React + 5173 Vite
set PUERTOS=8000 8001 8002 8003 8004 8005 8006 3000 5173
...
echo.
echo ============================================================
echo   Sistema detenido. Puertos 8000-8006 y 3000 liberados.
echo ============================================================
echo.
pause
